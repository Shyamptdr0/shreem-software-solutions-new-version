      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
          ...
          <div className="lg:col-span-9">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium text-gray-900 leading-[1.1] tracking-tight mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-24">
              <div>
                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-6">What we build</h3>
              ...
              <div>
                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-6">Our Focus</h3>
                <p className="text-xl md:text-2xl text-gray-500 font-light leading-relaxed">
            ...
            <div className="mt-32 pt-16 border-t border-gray-100 flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="flex items-center gap-6">
                <span className="text-5xl font-bold text-gray-900">2x</span>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest leading-tight">
